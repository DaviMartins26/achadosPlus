...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>AchadosPlus ADM</title>
        <link rel="stylesheet" href="index.css">
    </head>
    <body>
        <header class="top-bar">
            <nav class="barranav">
                <div class="pra deixar o logo do lado">
        ...
        <nav class="second-bar">
            <div class="menu-nav">
                ...
                <div class="divnav">                
                    ...
                    <a class="menu-btn" >Meus Protocolos</a>
                </div>
...
<main class="content-area">
    ...
    <div class="menu-principal">
        <div class="opt-menu-principal">
            ...
            <a class="descricao-a">Perdeu algo? Clique aqui para abrir um protocolo de perda de um item</a>
        </div>
        ...
        <div class="opt-menu-principal">
            ...
            <a class="descricao-a">Achou algo? Clique aqui para registrar o objeto.</a>
        </div>
    </div>
    ...
    <div class="menu-principal">
        <div class="opt-menu-principal">
            <div class="titulo-opt">
                ...
                <a class="descricao-a">Clique aqui para ver todos os protocolos.</a>
        </div>
        ...
        <div class="opt-menu-principal">
            <div class="titulo-opt">
                ...
                <a class="descricao-a">Clique aqui para ver objetos em estoque, perdidos, devolvidos e excluídos.</a>
            </div>
    ...
    <div class="menu-principal">
        <div class="menu-principal">
            ...
            <a class="descricao-a">Clique aqui para ver Log.</a>
        </div>
        ...
        <a class="descricao-a">Clique aqui para ver protocolos abertos por você.</a>
    </div>
